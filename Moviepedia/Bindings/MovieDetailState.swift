...
class MovieDetailState: ObservableObject {
    ...
    init(movieService: MovieService = MovieAPIClient.sharedInstance) { // we initialized MovieService bc "dependency injection" blah blah
    ...
    func loadMovie(id: Int) async {
        ...
        do {
            ...
            phase = .success(movie) // magic happened. turn it into successful.
        } catch {
